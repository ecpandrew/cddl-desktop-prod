...
public class FileAuthenticator implements IAuthenticator {
    ...
    FileAuthenticator(String parent, String filePath) {
        ...
        System.out.println("Moquette: Loading password file: " + file);
        if (file.isDirectory()) {
            System.out.println("Moquette: " + String.format("Bad file reference %s is a directory", file));
            return;
        }
        ...
        try {
            ...
            System.out.println("Moquette: " + String.format("Parsing not existing file %s", file) + fex);
        } catch (ParseException pex) {
            System.out.println("Moquette: " + String.format("Fromat ero in parsing password file %s", file) + pex);
        }
    }
