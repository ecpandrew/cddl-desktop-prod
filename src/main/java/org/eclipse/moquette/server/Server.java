...
public class Server {
    ...
    public static final String STORAGE_FILE_PATH = "moquette_store.mapdb";
    ...
    public void startServer(File configFile) throws IOException {
        System.out.println("Moquette: Using config file: " + configFile.getAbsolutePath());
        System.out.println("Moquette: Persistent store file: " + STORAGE_FILE_PATH);

        ConfigurationParser confParser = new ConfigurationParser();
        try {
            confParser.parse(configFile);
        } catch (ParseException pex) {
            System.out.println("Moquette: An error occurred in parsing configuration, fallback on default configuration" + pex);
        }
